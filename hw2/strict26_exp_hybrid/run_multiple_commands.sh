...
$CXX $CFLAGS -o hw2b_exp hw2b_exp.cc $LDLIBS
...
run_commands() {
    ...
    srun -N${NODE_NUM} -n${PROC_NUM} -c${CPU_NUM} /home/pp23/pp23s25/nsight-systems-2023.3.1/target-linux-x64/nsys \
	    profile --mpi-impl=mpich --trace=mpi ./hw2b_exp out_hybrid_exp.png 10000 -0.19985997516420825 -0.19673850548118335 -1.0994739550641088 -1.1010040371755099 7680 4320
