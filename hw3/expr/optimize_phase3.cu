...
__global__ void Phase1(int* d, int round, int V){
    ...
    for(int k = 0; k < blocksize; k ++){
        ...
        d[idx_d] = min(d[idx_d], d[idx2] + d[idx3]);
        d[idx_d + V * 32] = min(d[idx_d + V * 32], d[idx1] + d[idx3]);
        d[idx_d + 32] = min(d[idx_d + 32], d[idx2] + d[idx4]);
        d[idx_d + V * 32 + 32] = min(d[idx1], d[idx4]);
        __syncthreads();
    }
}
...
__global__ void Phase2(int* d, int round, int V){
    ...
    for(int k = 0; k < blocksize; k ++){
        ...
        d[idx_row_d] = min(d[idx_row_d], d[idx2] + d[idx3]);
        d[idx_row_d + V * 32] = min(d[idx_row_d + V * 32], d[idx1] + d[idx3]);
        d[idx_row_d + 32] = min(d[idx_row_d + 32], d[idx2] + d[idx4]);
        d[idx_row_d + V * 32 + 32] = min(d[idx_row_d + V * 32 + 32], d[idx1] + d[idx4]);
        ...
        d[idx_col_d] = min(d[idx_col_d], d[idx2] + d[idx3]);
        d[idx_col_d + V * 32] = min(d[idx_col_d + V * 32], d[idx1] + d[idx3]);
        d[idx_col_d + 32] = min(d[idx_col_d + 32], d[idx2] + d[idx4]);
        d[idx_col_d + V * 32 + 32] = min(d[idx_col_d + V * 32 + 32], d[idx1] + d[idx4]);
        __syncthreads();
    }
}
...
__global__ void Phase3(int* d, int round, int V){
    ...
    for(int k = 0; k < blocksize; k ++){
        ...
        d[idx_d + V * 32] = min(d[idx_d + V * 32], d[idx1] + d[idx3]);
        d[idx_d + 32] = min(d[idx_d + 32], d[idx2] + d[idx4]);
        d[idx_d + V * 32 + 32] = min(d[idx_d + V * 32 + 32], d[idx1] + d[idx4]);
    }
